...
class ReflectionEngine(
    ...
    ): List<MethodDescriptor> = descriptors(clazz.java, inheritanceLevel)
    ...
    fun findDescriptorExact(clazz: Class<*>, methodName: String, parameterTypes: List<Class<*>>): MethodDescriptor {
    ...
    fun invoke(methodId: MethodId, vararg args: Value): Any? = invoke(methodId, null, args.toList())
